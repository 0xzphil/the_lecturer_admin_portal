...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a id="open-upload-gv" href="#">Khởi tạo bằng excel</a></li>
          </ul>
        </li>
  ...
  <div id="main-content" class="content-wrapper">
    ...
    <!-- /.content -->
    <div id="formuploadGV" class ="form-group" style="margin-left:10px;display: none" ><form action="/uploadGV" method="post" enctype="multipart/form-data">

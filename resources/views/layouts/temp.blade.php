...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Andika|Lato|Roboto" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Raleway" rel="stylesheet">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <link rel="stylesheet" href="dist/css/fonts/stylesheet.css">
  <!-- Theme style -->
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>@if(Auth::user()->role == 'giang_vien')
                		Giảng viên
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p id="nguoi_dang_nhap1">@yield('nguoi-dang-nhap')</p>
